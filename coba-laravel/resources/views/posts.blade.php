...
@section('container')
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                     <div class="card">
                        ...
                        <div class="position-absolute px-3 py-2" style="background-color: rgba(0,0,0,0.75)"><a href="/posts?category={{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</a></div>
    ...
    <article class="mb-5 border-bottom pb-4">
        ...
        <p>By. <a href="/authors/{{ $post->author->username }}" class="text-decoration-none">{{ $post->author->name }}</a> in <a href="/categories/{{ $posts->category->slug }}"class="text-decoration-none"> {{ $post->category->name }}</a></p>
